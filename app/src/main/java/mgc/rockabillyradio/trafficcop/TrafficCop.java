package mgc.rockabillyradio.trafficcop;
...
public class TrafficCop {
     ...
     * {@link TrafficCop#register(Application)} then you don't need to call this.
     */
     ...
     * are using {@link TrafficCop#register(Application)} then you don't need to call
     * this.
     */
     ...
     * {@link #register(Application)} if you no longer want to be notified.
     */
    ...
    public static class Builder {
         ...
         * @param application the application context.
         * @return the TrafficCop
         * @see TrafficCop#register(Application)
         */
